...
std::tuple<Game::ACTIONS, sf::Vector2f> AI::get_airplane_action(Entity& me, std::list<Entity*> &surroundings)
{
...
std::tuple<Game::ACTIONS, sf::Vector2f> AI::get_antiaircraft_action(Entity& me, std::list<Entity*> &surroundings)
{
  Entity* current_worse_enemy = nullptr;
  int current_worse_enemy_priority = -1;
  sf::Vector2f my_position = me.getPosition();
...
std::tuple<Game::ACTIONS, sf::Vector2f> AI::get_infantry_action(Entity& me, std::list<Entity*> &surroundings)
{
  Entity* current_worse_enemy = nullptr;
  int current_worse_enemy_priority = -1;
  sf::Vector2f my_position = me.getPosition();
...
void AI::set_target(Entity& me, std::list<Entity*> &surroundings, Entity* current_worse_enemy, int &current_worse_enemy_priority)
{
